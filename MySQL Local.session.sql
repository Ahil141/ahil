...
INSERT INTO Ratings (user_id, restaurant_id, rating_value, review) VALUES
(1, 1, 5, 'Amazing food and great service!'),
(2, 1, 4, 'Good food but a bit pricey.'),
(1, 2, 3, 'Average experience. The service was slow.'),
(3, 2, 4, 'Liked the ambiance and the food.'),
(2, 3, 5, 'Excellent! Will visit again.'),
(4, 3, 2, 'Not worth the hype.');
